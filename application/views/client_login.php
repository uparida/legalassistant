                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form col-md-12 center-block">
                            ...
                            <a href="<?php echo site_url('client/questionnaire'); ?>" class="btn btn-outline btn-xl page-scroll  btn-lg">Quick Search Lawyers</a>
                            <a href="<?php echo site_url(''); ?>" class="btn btn-outline btn-xl page-scroll  btn-lg">Go to home page</a>
