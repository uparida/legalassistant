...
<div class="panel-group" id="accordion" ng-init="setBaseUrl('<?php echo base_url() ?>')">
            ...
            <div class="panel-body">
                <script type="text/javascript">
                    ...
                    function change_username() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>index.php/dashboard_controller/change_username",
            ...
            <div class="panel-body">
                <script type="text/javascript">
                    ...
                    function change_password() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>index.php/dashboard_controller/change_password",
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" > Select Category </a> </h4>
        </div>
        <div id="editpass" class="panel-collapse">
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" action="">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button ng-click="updateCategory()" class="btn btn-default " name="category" value="Submit">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
